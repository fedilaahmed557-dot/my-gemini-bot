...
API_KEY = os.getenv("AIzaSyCXjSYILLyHykiA3QPuyhC1csEtJqiaAUc") 
BOT_TOKEN = os.getenv("8608450246:AAF0Jjz3oNOcTUIavSIt9JJtOSqVK-m3U58") 
ADMIN_ID = 7268036089 
ID_PRICE = 30 
...
app = Flask('')
@app.route('/')
def home(): return "@My_Eza_Ai_Bot is running!"
